...
cl = LINE('EzGRuG4PuTJMCU6LaIQ8.w9L7AQ3fCeJZTUzYrLfzYa.cCkS85JaVV0e0Znn3LseaN5YYZlpPiwhFfqMWsnzDIs=')
cl.log("Auth Token : " + str(cl.authToken))
channelToken = cl.getChannelResult()

ka = LINE('EzyR3rT4vbgWSg5HeVla.RhItKa/snMcBdPb/fQpB/G.qenFak9ZlSS6WwJtPl4gTY3lTwvKRwe+dfjuDOFvv4M=')
ka.log("Auth Token : " + str(ka.authToken))

kb = LINE('EzPaObMYqsW3PlYx6XTd.ci8BjewpYBW2YALEm9WE+q.aaAKKPqGnsE/96oriXaljmRoBleoM6EcgYA3eiEZ2to=')
kb.log("Auth Token : " + str(kb.authToken))

kc = LINE('Ez1bztwKU2KzRtATcJVe.7TRab9DxV+HYCHDUJbtDFG.mMq+AvQvMS/byamJTBkkF3gPVSWG/4IG5y4RGG9zx8w=')
kc.log("Auth Token : " + str(kc.authToken))

kd = LINE('Ezsv7WHEVZoqHxfhlDO3.lwFE6gJEtXr3Kx+01mY0WW.vXheaou50MnhymLprnP/6/9MTlnQLajw1HcnW83halY=')
kd.log("Auth Token : " + str(kd.authToken))

#ke = LINE()
#ke.log("Auth Token : " + str(ke.authToken))

k1 = LINE('Ez9eYA3vpd0WUiAcYtId.sXQWzCpH1nkuvVH4Hetk7q.44o4s7Aiip4oYDbXUyWRylIUzDjo36idw6YWy/yKVXI=')
    ...
    try:
        ...
        if op.type == 11:
            ...
            if op.param2 in wait2["blacklist"]:
                if cl.getGroup(op.param1).preventedJoinByTicket == False:
                    if op.param2 not in Bots and op.param2 not in org["friend"]:
                        random.choice(KDC).reissueGroupTicket(op.param1)
                        X = random.choice(KDC).getGroup(op.param1)
                        X.preventedJoinByTicket = True
                        random.choice(K2C).updateGroup(X)
                        random.choice(K2C).kickoutFromGroup(op.param1,[op.param2])
